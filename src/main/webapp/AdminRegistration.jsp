...
<div class="row">
  ...
  <form action="AdminRegistration">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="otp" placeholder="Enter user name" name="uname" required>
    </div>
        
         <div class="form-group">
      <label for="pass">Enter Password:</label>
      <input type="text" class="form-control" id="otp" placeholder="Enter password" name="pass" required>
    </div>
    
     <div class="form-group">
      <label for="email">Enter Email:</label>
      <input type="email" class="form-control" id="otp" placeholder="Enter email" name="email" required>
    </div>
    <div class="form-group">
