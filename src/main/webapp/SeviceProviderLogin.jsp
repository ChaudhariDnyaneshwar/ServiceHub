...
<div class="main container-fluid" id="main">
	<form class="form-group" action="ServiceProviderLogin">
		<!-- heading -->
		<h1 class="heading">Sign In for Service Provider</h1>		
			<div class="control">
				<div class="row">
					<div class="col-lg-12">
						<!-- first name -->
						<label for="First name">Service Provider Name</label>
						...
						<span id="u1msg" class="errormsg">**invalid service provider name**</span>
					</div>
				</div>
			</div>
			...
			<div class="control">
		      ...
		      ${msg}<br>
		      ${rmsg}<br>
			<a href="#" class="mt-3">Forget password/Service provider Name</a>
			<br>
			<br>
